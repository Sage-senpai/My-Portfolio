...
const BOOT_LINES = [
  ...
  '  Loading [blockchain] [community] [fullstack] [content]',
  ...
  const runCommand = useCallback((cmd: string) => {
    ...
    if (lower === 'help') {
      ...
      pushOutput([
        ...
        '  └─────────────────────────────────────────────────────┘',
        '',
        '  Full stack Web3 engineer from Nsukka, Nigeria, with 4+ years',
        '  of experience building decentralized applications across',
        '  multiple blockchain ecosystems.',
        '',
        '  Started with React & TypeScript, evolved into a full-stack',
        '  Web3 engineer owning frontend, backend, smart contracts, and',
        '  deployment. Lead developer on client projects including Shopify',
        '  e-commerce and full-stack platforms. Core contributor to the',
        '  Polkadot ecosystem with 27+ shipped projects across 7+ chains.',
        '',
